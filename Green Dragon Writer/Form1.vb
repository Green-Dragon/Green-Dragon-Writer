...
Public Class Form1
    ...
    Private Sub BindCombo()
        ...
        ComboBox1.Font = New Font("Raleway, 7.75pt", 7.75)
    ...
    Private Sub Form1_FormClosing(sender As Object, e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Dim result As Integer = MsgBox("Would you like to save this document?", MsgBoxStyle.YesNo, Title:="Save Document")
...
#End Region
    ...
    Private Sub Button27_Click(sender As System.Object, e As System.EventArgs) Handles Button27.Click
        ...
        Dim result As Integer = MsgBox("Would you like to save the document?", MsgBoxStyle.YesNo, Title:="New Document")
        If result = MsgBoxResult.Yes Then
            'Calculates if the document should be updated or saved as a new document
            If Docname = "" Then
                SaveAsDocument()
    ...
    Public Sub SaveDocument()
        ...
        Catch ex As Exception
            LabelStatus.Text = "Status : " & "Error in saving document."
        End Try
    End Sub
    ...
    Private Sub Button6_Click(sender As System.Object, e As System.EventArgs) Handles Button6.Click
        Dim result As Integer = MsgBox("Would you like to save the document?", MsgBoxStyle.YesNo, Title:="Open Document")
        If result = MsgBoxResult.Yes Then
            'Calculates if the document should be updated or saved as a new document
            If Docname = "" Then
                SaveAsDocument()
